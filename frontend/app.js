...
// // //    ⚠️ Get a Google Maps API key from https://console.cloud.google.com/google/maps-apis
// // //       (enable "Maps JavaScript API"), then paste it below. Restrict the key to your
// // //       site's domain in the Cloud Console once you have a real domain.
// // //    ========================================================= */
...
// // //     s.src = `https://maps.googleapis.com/maps/api/js?key=${GOOGLE_MAPS_API_KEY}&callback=__onGoogleMapsLoaded`;
// // //     s.async = true;
// // //     s.onerror = reject;
...
// // // function fmtCategory(id){ const c = categoryMeta(id); return STATE.lang==='hi' ? c.name_hi : c.name_en; }
...
// // //         </div>
// // //         <a class="btn btn-primary btn-sm" href="#/map" style="white-space:nowrap;">📍 ${L==='hi'?'पास खोजें':'Explore Near Me'}</a>
...
// // //       if(STATE.map.userMarker) STATE.map.userMarker.setMap(null);
// // //       STATE.map.userMarker = new google.maps.Marker({
// // //         position: STATE.map.userLoc,
// // //         map: STATE.map.instance,
// // //         title: 'You are here',
// // //         icon: { path: google.maps.SymbolPath.CIRCLE, scale: 8, fillColor:'#BF5B34', fillOpacity:0.9, strokeColor:'#fff', strokeWeight:2 }
// // //       });
// // //       STATE.map.instance.setCenter(STATE.map.userLoc);
// // //       STATE.map.instance.setZoom(9);
// // //     }
// // //     updateNearbyList();
// // //   }, err=>{
...
// // //         map,
// // //         title: t(d,'name'),
// // //         icon: { path: google.maps.SymbolPath.CIRCLE, scale: 9, fillColor: color, fillOpacity: 0.95, strokeColor:'#fff', strokeWeight:2 }
// // //       });
...
// // //     updateNearbyList();
// // //   }).catch(()=>{
// // //     el.innerHTML = `<div style="padding:24px;font-size:0.85rem;color:var(--charcoal-soft);">${STATE.lang==='hi'?'मानचित्र लोड नहीं हो सका। कृपया Google Maps API कुंजी जांचें।':'Map failed to load. Please check the Google Maps API key.'}</div>`;
// // //   });
// // // }
...
// // //       <a class="btn btn-primary" href="#/map">🗺️ ${L==='hi'?'नक्शे पर देखें':'View on Map'}</a>
// // //       <a class="btn btn-ghost" href="https://www.google.com/maps/dir/?api=1&destination=${d.lat},${d.lng}" target="_blank" rel="noopener noreferrer">🧭 ${L==='hi'?'दिशा प्राप्त करें':'Get Directions'}</a>
// // //     </div>
...
// // //           ${d.images.map(img=>`<img src="${escapeHtml(img.url)}" alt="${escapeHtml(img.alt||t(d,'name'))}" onclick="window.open('${escapeHtml(img.url)}','_blank')"/>`).join('')}
// // //         </div>` : ''}
// // //       </div>
// // //       <div class="sidebar">
// // //         <div class="side-card">
...
// // //     category: fd.get('category'), lat: parseFloat(fd.get('lat')), lng: parseFloat(fd.get('lng')),
...
// // //     const map = L.map(el).setView([25.6, 85.8], 8);
